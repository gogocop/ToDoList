...
public class AddNewTask extends BottomSheetDialogFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        newDescriptionText = requireView().findViewById(R.id.newDescriptionText);
        newTypeText = requireView().findViewById(R.id.newTypeText);
        ...
        newTaskSaveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String type = newTypeText.getText().toString();

                if (finalIsUpdate) {
                    // If it's an update, update all the values
                    db.updateTask(bundle.getInt("id"), text);
                    db.updateDescription(bundle.getInt("id"), description);
                    db.updateType(bundle.getInt("id"), type);
                } else {
                    // If it's a new task, create a new ToDoModel and set all the values
